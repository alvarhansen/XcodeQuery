...
Status
- Completed; legacy parser/AST/executor removed (2026-02-01).

Goal
- Remove the bespoke GraphQL parser/AST/executor once GraphQL runtime has proven stable in production.
...
- Clean up tests/fixtures that only targeted the legacy implementation, replacing them with GraphQL runtime-focused coverage where needed.
...
- Simplified documentation and onboarding materials pointing exclusively to GraphQL runtime implementation details.
