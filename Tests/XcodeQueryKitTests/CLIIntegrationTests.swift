...
final class CLIIntegrationTests: XCTestCase {
    func testXCQListsTargetsFromGeneratedProject() throws {
        ...
        // Act: run xcq CLI
        let xqPath = try Self.locateXCQBinary()
        ...
        if status2 != 0 {
            XCTFail("xcq deps failed (\(status2)): \nSTDERR: \(stderr2)\nSTDOUT: \(stdout2)")
            return
        }
        ...
        if status6 != 0 { XCTFail("xcq pipeline failed (\(status6)):\nSTDERR: \(stderr6)\nSTDOUT: \(stdout6)"); return }
        ...
        if status3 != 0 { XCTFail("xcq deps recursive failed (\(status3)):\nSTDERR: \(stderr3)\nSTDOUT: \(stdout3)"); return }
        ...
        if status4 != 0 { XCTFail("xcq dependents failed (\(status4)):\nSTDERR: \(stderr4)\nSTDOUT: \(stdout4)"); return }
        ...
        if status5 != 0 { XCTFail("xcq dependents recursive failed (\(status5)):\nSTDERR: \(stderr5)\nSTDOUT: \(stdout5)"); return }
        ...
        if status8 != 0 { XCTFail("xcq pipeline dependents failed (\(status8)):\nSTDERR: \(stderr8)\nSTDOUT: \(stdout8)"); return }
        ...
        if status9 != 0 { XCTFail("xcq pipeline dependents recursive failed (\(status9)):\nSTDERR: \(stderr9)\nSTDOUT: \(stdout9)"); return }
        ...
        if status10 != 0 { XCTFail("xcq sources failed (\(status10)):\nSTDERR: \(stderr10)\nSTDOUT: \(stdout10)"); return }
        ...
        if status11 != 0 { XCTFail("xcq sources pipeline failed (\(status11)):\nSTDERR: \(stderr11)\nSTDOUT: \(stdout11)"); return }
        ...
        if status12 != 0 { XCTFail("xcq targetMembership failed (\(status12)):\nSTDERR: \(stderr12)\nSTDOUT: \(stdout12)"); return }
        ...
        if status13 != 0 { XCTFail("xcq pipeline targetMembership failed (\(status13)):\nSTDERR: \(stderr13)\nSTDOUT: \(stdout13)"); return }
        ...
        if status7 != 0 { XCTFail("xcq reverseDependencies failed (\(status7)):\nSTDERR: \(stderr7)\nSTDOUT: \(stdout7)"); return }
        ...
        if status14 != 0 { XCTFail("xcq buildScripts failed (\(status14)):\nSTDERR: \(stderr14)\nSTDOUT: \(stdout14)"); return }
        ...
        if status15 != 0 { XCTFail("xcq pipeline buildScripts failed (\(status15)):\nSTDERR: \(stderr15)\nSTDOUT: \(stdout15)"); return }
        ...
        if status16 != 0 { XCTFail("xcq pipeline buildScripts filter failed (\(status16)):\nSTDERR: \(stderr16)\nSTDOUT: \(stdout16)"); return }
        ...
        if status17 != 0 { XCTFail("xcq pipeline name equality failed (\(status17)):\nSTDERR: \(stderr17)\nSTDOUT: \(stdout17)"); return }
        ...
        if status18 != 0 { XCTFail("xcq sources regex filter failed (\(status18)):\nSTDERR: \(stderr18)\nSTDOUT: \(stdout18)"); return }
    ...
    private static func locateXCQBinary() throws -> String {
        ...
        // Fallback to .build/debug/xcq
        let fallback = URL(fileURLWithPath: root).appendingPathComponent(".build/debug/xcq").path
        return fallback
    }
